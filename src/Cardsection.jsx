    ...
    <section className="bg-[#E6EFE9] py-14 sm:py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="rounded-xl p-6 sm:p-8 text-center bg-linear-to-br from-[#0E7A4F] to-[#064E32] text-white shadow-2xl">
            <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-6 rounded-full bg-white flex items-center justify-center">
              <img
          ...
          <div className="group bg-white rounded-xl p-6 sm:p-8 text-center transition-all duration-700 ease-in-out hover:-translate-y-2 hover:shadow-2xl hover:bg-linear-to-br hover:from-[#0E7A4F] hover:to-[#064E32]">
            <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-6 rounded-full bg-[#0E7A4F] flex items-center justify-center transition-all duration-700">
              <img
                src="/rent-icon.png"
                alt="Sewa Rumah"
                className="w-7 h-7 sm:w-8 sm:h-8 object-contain"
